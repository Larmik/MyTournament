...
<nav>
    <ul>
        ...
        <c:if test="${!sessionScope.isConnected}">
            ...
            <li><a href="#" onclick="alert('Veuillez vous connecter pour participer à un tournoi')">Participer à un
                tournoi</a></li>
            <li><a href="#" onclick="alert('Veuillez vous connecter pour créer ou rejoindre une équipe')">Créer une
                équipe</a></li>
        </c:if>
    </ul>
    <c:if test="${sessionScope.isConnected}">
