...
<body>
    ...
    <div>Lorem ipsum dolor amet tumblr lomo synth shoreditch kinfolk, pok pok cornhole taiyaki cold-pressed mlkshk try-hard.
    ...
    <a href="signin.jsp">Je m'inscris</a>
    <span>ou</span>
    <a href="login.jsp">Je me connecte</a>
